...
public class DatabaseSeeder implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // 4. Remove all older events and transaction logs natively using JdbcTemplate
        System.out.println("[DatabaseSeeder] Purging older events and transactional records to establish fresh test environment...");
